function Quad_PM_by_task(tbl,tblName,ResultsDir,saveLME,colormap, sorted_idx)
% Quad_PM_by_task(tbl,tblName,ResultsDir,saveLME,colormap, sorted_idx)
...
%plot PM by distance different colors per subject sorted by PM in
%perceptual task
%
