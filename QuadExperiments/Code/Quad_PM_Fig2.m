...
ResultsDir=fullfile(expDir,'Paper_Fig2_110425');
...
realVA=0.5;
perceivedVA=mean_slope_adjusted*realVA;
distance_mm=500;
saveFlag=1
saveFilename=fullfile(ResultsDir, [QuadBasename '_Adjusted_visualize_PM.png']);
[realheight_mm,perceivedheight_mm] = visualizePM(realVA,perceivedVA,distance_mm,saveFlag,saveFilename)
