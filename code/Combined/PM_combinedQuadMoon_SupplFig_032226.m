...
ResultsDir='/Users/kalanit/Projects/PerceptualMagnification/Paper/ExperimentalData/combinedQuadMoon/SupplFig_QuadMoon_032326'
...
ResultsDir='/Users/kalanit/Projects/PerceptualMagnification/Paper/ExperimentalData/combinedQuadMoon/SupplFig_QuadMoon_032326_absElevationRAD'
if ~exist('ResultsDir','dir')
  mkdir(ResultsDir)
end
...
%%
%% Now let's calculate models
ResultsDir='/Users/kalanit/Projects/PerceptualMagnification/Paper/ExperimentalData/combinedQuadMoon/SupplFig_QuadMoon_032326_ElevationRAD'
if ~exist('ResultsDir','dir')
  mkdir(ResultsDir)
end

% this is for radians
ElevationTransform=1; % 1 elevation; 2: abs(elevation) 
degreeFlag=1; % show xtick for angles in degrees
...
%%
%% Now let's calculate models
ResultsDir='/Users/kalanit/Projects/PerceptualMagnification/Paper/ExperimentalData/combinedQuadMoon/SupplFig_QuadMoon_032326_ElevationD90'
if ~exist('ResultsDir','dir')
  mkdir(ResultsDir)
end

% this is for radians
ElevationTransform=3; % 3 elevation/; 4: abs(elevation/90) 
...
%% 
%% Now let's calculate models
ResultsDir='/Users/kalanit/Projects/PerceptualMagnification/Paper/ExperimentalData/combinedQuadMoon/SupplFig_QuadMoon_032326_absElevationD90'
if ~exist('ResultsDir','dir')
  mkdir(ResultsDir)
end

% this is for radians
ElevationTransform=4; % 3 elevation/; 4: abs(elevation/90) 
