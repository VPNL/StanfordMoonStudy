...
SMS_setCodePath;
% set dirs
expDir='/Users/kalanit/Projects/PerceptualMagnification/Paper/ExperimentalData/';

combinedDir='/Users/kalanit/Projects/PerceptualMagnification/Paper/ExperimentalData/Combined/';
ResultsDir='/Users/kalanit/Projects/PerceptualMagnification/Paper/ExperimentalData/PaperFigures/PM_Fig3ab_CombinedQuadMoon_PM_072126'
...
cmap_moon=brighten(colormap(purpleVioletBlueTurquoiseColorMap(nsubjects_moon)),0);
...
all_quad_data=table(all_quad_data.ID,all_quad_data.Real_Visual_Angle,all_quad_data.Distance, all_quad_data.Elevation,...
                       all_quad_data.Task, all_quad_data.Reported_Visual_Angle,all_quad_data.Ratio_Visual_Angle,...
                       'VariableNames',colNames);
hh=height(all_quad_data);
for h=1:hh
    all_quad_data.Study(h)={'QuadStudy'};
end
% sort subjects by PM in Perceptual task
task='Perceptual';
task_p=find(strcmp(all_quad_data.Task,task));
quad_data_perceptual=all_quad_data(task_p,:);

% task='Adjusted';
% task_a=find(strcmp(all_quad_data.Task,task));
% quad_data_adjusted=all_quad_data(task_a,:);
