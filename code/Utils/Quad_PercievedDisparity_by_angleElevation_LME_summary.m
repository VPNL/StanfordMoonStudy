function summaryTbl = Quad_PercievedDisparity_by_angleElevation_LME_summary(study, ...
    lme_logPM_by_logAngle, lme_logPM_by_logElevation, lme_logPM_by_logAngleNElevation, outCsvFile)
% QUAD_PERCIEVEDDISPARITY_BY_ANGLEELEVATION_LME_SUMMARY
% Export a tidy summary table for visual-angle/elevation perceived-disparity LMEs.
...
if nargin < 4 || isempty(outCsvFile)
    ...
    outDir = fullfile(baseDir, 'AngleElevationModel');
