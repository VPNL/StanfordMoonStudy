function [PM, realheight_mm, perceivedheight_mm] = visualizePerceivedSize_VA_D_E_model(lme_logPM_by_logAngleNDistanceNElevation,VA,D,E,distance_mm, saveFilename)
% [PM, realheight_mm, perceivedheight_mm] = visualizePerceivedSize_VA_D_E_model(lme_logPM_by_logAngleNDistanceNElevation,VA,D,E,distance_mm, saveFilename)
%  visualize perceived size for an object of visual angle VA at a distance D and elevation E at aviewing distance of distance_mm
...
h=visualangle2height(.5,500)

drawRealPereivedPredictedVA(realRadius_mm, perceivedRadius_mm, predictedRadius_mm, textstring, saveFlag,saveFilename, mycolor)
