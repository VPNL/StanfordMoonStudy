...
if saveLME
    ...
    savelmefile = fullfile(ResultsDir, [tblName '_distance_elevation_RI_dual.txt']);
    diary(savelmefile);
...
figh = figure('Color', [1 1 1], 'Units', 'normalized', 'Position', [0 0 1 .8], 'Name', tblName, 'Visible', 'off');
