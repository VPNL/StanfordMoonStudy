function [lme_logPM_by_logAngle, lme_logPM_by_logElevation, lme_logPM_by_logAngleNElevation] = ...
    Quad_PerceivedDisparity_by_angleElevation(tbl, tblName, ResultsDir, saveLME, mycolormap, sorted_idx, modelTransform, degreeFlag, fullUniqueID, removeOutlierParticipants)
% QUAD_PERCEIVEDDISPARITY_BY_ANGLEELEVATION
% Visual-angle/elevation-only mirror of Quad_PerceivedDisparity_by_task.
...
ResultsDir = local_angle_elevation_dir(ResultsDir);
...
figh = figure('Color', [1 1 1], 'Units', 'normalized', 'Position', [0 0 .8 .6], 'Name', tblName, 'Visible', 'off');
...
function ResultsDir = local_angle_elevation_dir(ResultsDir)
