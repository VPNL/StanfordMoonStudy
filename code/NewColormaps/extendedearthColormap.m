function cmap = extendedearthColormap(nLevels, varargin)
...
%     to the colormap via the axes CLim (aka caxis).
    ...
    ctrl = [
        ...
        0.1 0.4 0.10    % dark green
     
        0.1  0.40 .40   %  blue green(sky)
        0.10 0.5 0.70  % medium blue (not too dark)
        0.70 0.90 1.00  % light blue (sky)
    ];
