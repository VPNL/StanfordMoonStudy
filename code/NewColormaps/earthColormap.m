function cmap = earthColormap(nLevels, varargin)
...
%     to the colormap via the axes CLim (aka caxis).
    ...
    ctrl = [
        0.2 0.1 0.06  % dark brown
        0.5 0.26 0.10  % earthy brown
        0.1 0.6 0.20  % green        
        0.10 0.35 0.70  % medium blue (not too dark)
        %0.60 0.80 1.0  % light blue (sky)
        0.90 0.90 1.00  % light blue (sky)
