...
cd(expDir)
datafile='QuadMatchingProcessedData0421.csv';

basename = erase(datafile,'.csv'); % for saving
saveLME=1;
ObserverFlag=1; % use Observer referred distances and elevations
...
datafile=fullfile(expDir,'Data',datafile)
...
%% remove subject 26 who did not follow instructions
