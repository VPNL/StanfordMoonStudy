...
% ResultsDir=fullfile(expDir,'Paper_Fig2cd_012526');
ObserverFlag=1; %refer elevations and distances to observer line of sight otherwise use ground referred values
ElevationTransform=1; % use signed elevation in the standard log2(1+E) model
QuadFile='MatchingData0318.csv';
ResultsDir=fullfile(expDir,'Paper_Fig2cd_031926');
...
[Perceptual_lme_logPM_by_logAngle,Perceptual_lme_logPM_by_logDistance,Perceptual_lme_logPM_by_logElevation,...
    ...
    Perceptual_lme_logPM_by_logAngleNDistanceNElevation]=Quad_PM_by_task(all_data_perceptual,Perceptual_tblName,ResultsDir,saveLME,cmap, sorted_idx, ElevationTransform);
...
[lme_test] = fit_PM_full_VA_D_E_model(all_data_perceptual,[Perceptual_tblName '_fullmodel_fit' task], ResultsDir, saveLME, cmap, sorted_idx,ElevationTransform);


VAmax=8;
distance_mm=500;
FigName=Perceptual_tblName;
visualize_real_perceived_predicted(all_data_perceptual,Perceptual_lme_logPM_by_logAngleNDistanceNElevation,visualizeDir,FigName,VAmax, distance_mm,ElevationTransform)
...
[Adjusted_lme_logPM_by_logAngle,Adjusted_lme_logPM_by_logDistance,Adjusted_lme_logPM_by_logElevation,...
    ...
    Adjusted_lme_logPM_by_logAngleNDistanceNElevation]=Quad_PM_by_task(all_data_adjusted,Adjusted_tblName,ResultsDir,saveLME,cmap, sorted_idx, ElevationTransform);
...
[lme_test] = fit_PM_full_VA_D_E_model(all_data_adjusted,[Adjusted_tblName '_fullmodel_fit' task], ResultsDir, saveLME, cmap, sorted_idx,ElevationTransform);

VAmax=8;
distance_mm=500;
FigName=Adjusted_tblName;
visualize_real_perceived_predicted(all_data_adjusted,Adjusted_lme_logPM_by_logAngleNDistanceNElevation,visualizeDir,FigName,VAmax, distance_mm,ElevationTransform)
