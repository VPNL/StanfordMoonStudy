% Quad_PM_Fig2cd_angle_distance_elevation_0320226
%.
...
if ElevationTransform==1
    ResultsDir=fullfile(expDir,'Paper_Fig2cd_032226_ElevationRAD');
elseif  ElevationTransform==2
    ResultsDir=fullfile(expDir,'Paper_Fig2cd_032226_absElevationRAD');
end
...
[Perceptual_lme_logPM_by_logAngle,Perceptual_lme_logPM_by_logDistance,Perceptual_lme_logPM_by_logElevation,...
    ...
    Perceptual_lme_logPM_by_logAngleNDistanceNElevation]=Quad_PM_by_task_rad(all_data_perceptual,Perceptual_tblName,ResultsDir,saveLME,cmap, sorted_idx,ElevationTransform,degreeFlag);
...
[lme_test] = fit_PM_full_VA_D_Erad_model(all_data_perceptual,[Perceptual_tblName '_fullmodel_fit' task], ResultsDir, saveLME, cmap, sorted_idx,ElevationTransform,degreeFlag);
...
[Adjusted_lme_logPM_by_logAngle,Adjusted_lme_logPM_by_logDistance,Adjusted_lme_logPM_by_logElevation,...
    ...
    Adjusted_lme_logPM_by_logAngleNDistanceNElevation]=Quad_PM_by_task_rad(all_data_adjusted,Adjusted_tblName,ResultsDir,saveLME,cmap, sorted_idx, ElevationTransform,degreeFlag);
...
[lme_test] = fit_PM_full_VA_D_Erad_model(all_data_adjusted,[Adjusted_tblName '_fullmodel_fit' task], ResultsDir, saveLME, cmap, sorted_idx,ElevationTransform,degreeFlag);
