function summaryTbl = Quad_export_LME_summary_csv(study, task, ...
...
%
%  summaryTbl = Quad_export_LME_summary_csv(study, task, ...
%     lme_logPM_by_logAngle, lme_logPM_by_logDistance, lme_logPM_by_logElevation, ...
%     lme_logPM_by_logAngleNDistance, lme_logPM_by_logAngleNElevation, lme_logPM_by_logDistanceNElevation, ...
%    lme_logPM_by_logAngleNDistanceNElevation,outCsvFile)
%  
...
% KGS Jan 2026
    ...
    for i = 1:n
        ...
        [e, cL, cU, p] = localGetCoef(lme, {"log2real_visual_angle"}, false);
        summaryTbl.VAe(i)   = e;
        summaryTbl.VAciL(i) = cL;
        summaryTbl.VAciU(i) = cU;
        summaryTbl.VAp(i)   = p;
