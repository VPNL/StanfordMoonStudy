% Quad_PerceivedDisparity_distance_elevation_032626
...
for transformId = ElevationTransforms
    ...
    for iVersion = 1:numel(analysisSpecs)
        ...
        lme_full = fit_PerceivedDisparity_by_DistanceElevation_lme(tblSubset, [tblName '_fullmodel_fit'], VersionResultsDir, saveLME, cmap, sorted_color_idx, transformId, uniqueID, removeOutlierParticipants);
...
save(fullfile(ResultsDir, [QuadBasename '_perceived_disparity_distance_elevation_results.mat']), ...
