...
ResultsDir=fullfile(expDir,'Paper_Fig2cd_0318', QuadBasename);
...
jj=find(all_data_perceptual.Elevation<0);
% let's only include the positive elevations
positiveonly=0;
if positiveonly
    all_data_perceptual=all_data_perceptual(ii,:);
else % take absolute values
    %all_data_perceptual=all_data_perceptual(jj,:);
    all_data_perceptual.Elevation(jj)= -all_data_perceptual.Elevation(jj);
    [Perceptual_lme_PM_by_Angle,Perceptual_lme_PM_by_Distance,Perceptual_lme_PM_by_Elevation,...
    Perceptual_lme_PM_by_AngleNDistance, Perceptual_lme_PM_by_AngleNElevation, Perceptual_lme_PM_by_DistanceNElevation,...
    Perceptual_lme_PM_by_AngleNDistanceNElevation]=Quad_PM_by_task_linear(all_data_perceptual,['abs_' Perceptual_tblName],ResultsDir,saveLME,cmap, sorted_idx);
...
[lme_test] = fit_PM_full_VA_D_E_model(all_data_perceptual,[Perceptual_tblName '_fullmodel_fit' task], ResultsDir, saveLME, cmap, sorted_idx);
...
ii=find(all_data_adjusted.Elevation>0);
jj=find(all_data_adjusted.Elevation<0);
if positiveonly
    all_data_adjusted=all_data_adjusted(ii,:);
else % take absolute values
    %all_data_perceptual=all_data_perceptual(jj,:);
    all_data_adjusted.Elevation(jj)= -all_data_adjusted.Elevation(jj);
    [Perceptual_lme_PM_by_Angle,Perceptual_lme_PM_by_Distance,Perceptual_lme_PM_by_Elevation,...
    Perceptual_lme_PM_by_AngleNDistance, Perceptual_lme_PM_by_AngleNElevation, Perceptual_lme_PM_by_DistanceNElevation,...
    Perceptual_lme_PM_by_AngleNDistanceNElevation]=Quad_PM_by_task_linear(all_data_adjusted,['abs_' Adjusted_tblName],ResultsDir,saveLME,cmap, sorted_idx);
...
[lme_test] = fit_PM_full_VA_D_E_model(all_data_adjusted,[Adjusted_tblName '_fullmodel_fit' task], ResultsDir, saveLME, cmap, sorted_idx);
