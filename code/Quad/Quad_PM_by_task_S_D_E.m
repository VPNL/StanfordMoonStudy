function [lme_logPM_by_logSize,lme_logPM_by_logDistance,lme_logPM_by_logElevation,...
    lme_logPM_by_logSizeNDistance, lme_logPM_by_logSizeNElevation, lme_logPM_by_logDistanceNElevation,...
    lme_logPM_by_logSizeNDistanceNElevation]=Quad_PM_by_task_S_D_E(tbl,tblName,ResultsDir,saveLME,colormap, sorted_idx,ElevationTransform)
% [lme_logPM_by_logSize,lme_logPM_by_logDistance,lme_logPM_by_logElevation,...
% lme_logPM_by_logSizeNDistance, lme_logPM_by_logSizeNElevation, lme_logPM_by_logDistanceNElevation,...
% lme_logPM_by_logSizeNDistanceNElevation]=Quad_PM_by_task(tbl,tblName,ResultsDir,saveLME,colormap, sorted_idx,ElevationTransform)
% 
...
lme_logPM_by_logSizeNElevation= fitlme(tbl,'log2ratio_visual_angle ~ log2Size + log2elevation + (1| ID)');
lme_logPM_by_logDistanceNElevation= fitlme(tbl,'log2ratio_visual_angle ~ log2distance + log2elevation + (1| ID)');

lme_logPM_by_logSizeNDistanceNElevation= fitlme(tbl,'log2ratio_visual_angle ~ log2Size + log2distance + log2elevation+ (1| ID)');
if saveLME
    ...
    reportOpts.ModelLabel = 'Log perceptual magnification predicted by log size, log distance, and log elevation';
    reportOpts.SummaryLines = { ...
        ...
        lme_logPM_by_logSizeNDistanceNElevation.Rsquared.Ordinary, ...
        lme_logPM_by_logSizeNDistanceNElevation.Rsquared.Adjusted)};
    reportOpts.Models = { ...
    ...
    reportOpts.ModelLabels = { ...
        ...
        'Model: log2ratio_visual_angle ~ log2Size + log2elevation + (1|ID)', ...
        'Model: log2ratio_visual_angle ~ log2distance + log2elevation + (1|ID)', ...
        'Model: log2ratio_visual_angle ~ log2Size + log2distance + log2elevation + (1|ID)'};
    reportOpts.Comparisons = { ...
        compare(lme_logPM_by_logSize, lme_logPM_by_logSizeNDistance), ...
        compare(lme_logPM_by_logSize, lme_logPM_by_logSizeNElevation), ...
        ...
        compare(lme_logPM_by_logElevation, lme_logPM_by_logSizeNElevation), ...
        compare(lme_logPM_by_logElevation, lme_logPM_by_logDistanceNElevation), ...
        compare(lme_logPM_by_logSizeNDistance, lme_logPM_by_logSizeNDistanceNElevation), ...
        compare(lme_logPM_by_logSizeNElevation, lme_logPM_by_logSizeNDistanceNElevation), ...
        compare(lme_logPM_by_logDistanceNElevation, lme_logPM_by_logSizeNDistanceNElevation), ...
        compare(lme_logPM_by_logSize, lme_logPM_by_logSizeNDistanceNElevation), ...
        compare(lme_logPM_by_logDistance, lme_logPM_by_logSizeNDistanceNElevation), ...
        compare(lme_logPM_by_logElevation, lme_logPM_by_logSizeNDistanceNElevation)};
    reportOpts.ComparisonLabels = { ...
        'Model comparison: size vs size + distance', ...
        'Model comparison: size vs size + elevation', ...
        'Model comparison: distance vs size + distance', ...
        'Model comparison: distance vs distance + elevation', ...
        'Model comparison: elevation vs size + elevation', ...
        'Model comparison: elevation vs distance + elevation', ...
        'Model comparison: size + distance vs size + distance + elevation', ...
        'Model comparison: size + elevation vs size + distance + elevation', ...
        'Model comparison: distance + elevation vs size + distance + elevation', ...
        'Model comparison: size vs size + distance + elevation', ...
        'Model comparison: distance vs size + distance + elevation', ...
        'Model comparison: elevation vs size + distance + elevation'};
    reportOpts.RemoveGroupError = false;
    write_lme_stats_report(lme_logPM_by_logSizeNDistanceNElevation, savelmefile, reportOpts);

    objectReportVars = {'Measurement','ID','Size','Distance','Elevation','Ratio_Visual_Angle'};
    ...
    if isempty(missingObjectReportVars)
        ...
        write_quad_pm_object_prediction_report(tbl, lme_logPM_by_logSizeNDistanceNElevation, objectReportFile, objectReportOpts);
    else
...
intercept_fe=lme_logPM_by_logSizeNDistanceNElevation.Coefficients.Estimate(1);
VA_fe=lme_logPM_by_logSizeNDistanceNElevation.Coefficients.Estimate(2);
pval_VA=lme_logPM_by_logSizeNDistanceNElevation.Coefficients.pValue(2);
distance_fe=lme_logPM_by_logSizeNDistanceNElevation.Coefficients.Estimate(3);
pval_distance=lme_logPM_by_logSizeNDistanceNElevation.Coefficients.pValue(3);
elevation_fe=lme_logPM_by_logSizeNDistanceNElevation.Coefficients.Estimate(4);
pval_elevation=lme_logPM_by_logSizeNDistanceNElevation.Coefficients.pValue(4);
% full formula
