...
lme_by_logRatio_by_Elevation_Perceptual=FullMoon_PM_by_task_logRAD(dataDir,datafile,ResultsDir,task, recomputeSort, saveLME)
%%
...
lme_by_logRatio_by_Elevation_Adjusted=FullMoon_PM_by_task_logRAD(dataDir,datafile,ResultsDir,task, recomputeSort, saveLME)
