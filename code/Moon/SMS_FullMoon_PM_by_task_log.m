...
if saveLME
   ...
   reportStem = fullfile(ResultsDir, ...
       [basename '_' task '_lme_moon_logRatio_by_Elevation']);
   reportTitle = sprintf( ...
       'Moon log perceptual magnification by log elevation: %s %s', ...
       datafile, task);

   write_moon_lme_report([reportStem '_RI.txt'], ...
       [reportTitle ' - random-intercept model'], ...
       summaryLines, ...
       {lme_by_logRatio_by_Elevation}, ...
       {'Random-intercept model: logRatio ~ logElevation + (1|ID)'}, ...
       {}, {});

   write_moon_lme_report([reportStem '_RS.txt'], ...
       [reportTitle ' - random-slope model'], ...
       summaryLines, ...
       {lme_by_logRatio_by_Elevation_RS}, ...
       {'Random-slope model: logRatio ~ logElevation + (logElevation|ID)'}, ...
       {}, {});

   write_moon_lme_report([reportStem '_RI_vs_RS_comparison.txt'], ...
       [reportTitle ' - RI versus RS model comparison'], ...
       [summaryLines; { ...
       'Random-intercept formula: logRatio ~ logElevation + (1|ID)'; ...
       'Random-slope formula: logRatio ~ logElevation + (logElevation|ID)'}], ...
       {}, {}, ...
       {model_comp_log}, ...
       {'Random-intercept versus random-slope model comparison'});
end
...
if saveLME
   ...
   reportStem = fullfile(ResultsDir, ...
       [basename '_' task '_lme_moon_ratio_by_Elevation']);
   reportTitle = sprintf( ...
       'Moon perceptual magnification by elevation: %s %s', ...
       datafile, task);
   ...
   write_moon_lme_report([reportStem '_RI.txt'], ...
       ...
       {'Random-intercept model: Ratio_Visual_Angle ~ Elevation + (1|ID)'}, ...
       {}, {});
   ...
   write_moon_lme_report([reportStem '_RS.txt'], ...
       ...
       {'Random-slope model: Ratio_Visual_Angle ~ Elevation + (Elevation|ID)'}, ...
       {}, {});

   write_moon_lme_report([reportStem '_RI_vs_RS_comparison.txt'], ...
       [reportTitle ' - RI versus RS model comparison'], ...
       [summaryLines; { ...
       'Random-intercept formula: Ratio_Visual_Angle ~ Elevation + (1|ID)'; ...
       'Random-slope formula: Ratio_Visual_Angle ~ Elevation + (Elevation|ID)'}], ...
       {}, {}, ...
       {model_comp}, ...
       {'Random-intercept versus random-slope model comparison'});
end
