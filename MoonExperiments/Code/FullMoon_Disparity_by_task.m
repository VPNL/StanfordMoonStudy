function [outputArg1,outputArg2] = FullMoon_Disparity_by_task(dataDir,datafile,ResultsDir,task, recomputeSort,saveLME)
%
% [outputArg1,outputArg2] = FullMoon_Disparity_by_task(dataDir,datafile,ResultsDir,task, recomputeSort,saveLME)
...
allowed_dates = {'Jan 12th', 'Jan 13th', 'May 13th'};  %  allowed dates we excludw 'Nov 15th' data because of incomplete data as there is only a disparity measurement for the higher elevation
