function drawPM(circleRadius_mm, perceivedRadius_mm, saveFlag,saveFilename, mycolor)
...
circleCenter_x_mm = imgWidth_mm/2-imgWidth_mm/10; % Center the 1st circle horizontally in the image
circleCenter_y_mm = imgHeight_mm/2; % Center the 1st circle vertically in the image
PMcircleCenter_x_mm = imgWidth_mm/2+imgWidth_mm/10; % Center the 2nd circle horizontally in the image
...
img= insertShape(img, 'FilledCircle', [circleCenter_x_pixels, circleCenter_y_pixels, circleRadius_pixels], 'ShapeColor', mycolor,'Opacity',1);
img= insertShape(img, 'FilledCircle', [PMcircleCenter_x_pixels, circleCenter_y_pixels,PMcircleRadius_pixels], 'ShapeColor',mycolor ,'Opacity',1);
