function [realheight_mm,perceivedheight_mm] = visualizePM(realVA,perceivedVA,distance_mm,saveFlag,saveFilename)
...
drawPM(realheight_mm/2, perceivedheight_mm/2, saveFlag,saveFilename)
