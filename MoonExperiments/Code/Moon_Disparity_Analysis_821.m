...
allowed_dates = {'Jan 12th', 'Jan 13th', 'May 13th' 'Aug 7th' 'Aug 9th'};  %  
...
slope_indices = contains(reNames.Name, 'Altitude');
...
subjSlopes = random_intercepts + feEfx(2); 
%Find the indices corresponding to the random intercepts
[sortedIntercepts, sortedIdx]=sort(subjIntercepts);
...
xlim([0 max(disparity_data.Altitude)]);
...
%         xvectorS=[0 sdata.Altitude(higher)];
...
% === Reuse colormap for the second plot ===
