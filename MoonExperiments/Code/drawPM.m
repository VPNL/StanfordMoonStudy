...
circleCenter_x_mm = imgWidth_mm/3; % Center the 1st circle horizontally in the image
circleCenter_y_mm = imgHeight_mm/2; % Center the 1st circle vertically in the image
PMcircleCenter_x_mm = 2*imgWidth_mm/3; % Center the 2nd circle horizontally in the image
