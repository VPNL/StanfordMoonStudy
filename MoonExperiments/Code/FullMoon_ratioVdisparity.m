...
lme_ratio_by_disparity_Elevation_RS = fitlme(disparity_data,'Ratio_Visual_Angle~Disparity_VA + Elevation+ (Disparity_VA|ID)');
lme_ratio_by_Elevation_RS = fitlme(disparity_data,'Ratio_Visual_Angle~ Elevation+ (Disparity_VA|ID)');
