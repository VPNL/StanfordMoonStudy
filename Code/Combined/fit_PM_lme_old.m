function [lme] = fit_PM_lme_old(tbl, tblName, ResultsDir, saveModels, mycolormap, sorted_idx)
% fit_PM_lme
%
% Fits:
...
local_plot_one_predictor_lme(nexttile, tbl, subjectcolor, lme, ...
    'log2elevation', {'Elevation+1 [deg]', 'log scale'}, muX, minPMLim, maxPMLim);
...
mm=get(gca,'Xtick');set(gca,'XtickLabel',round(2.^mm,1)); 
