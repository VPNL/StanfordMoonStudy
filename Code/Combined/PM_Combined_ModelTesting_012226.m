% PM_Combined_ModelTesting_012226.m
...
ResultsDir = '/Users/kalanit/Projects/PerceptualMagnification/Paper/ExperimentalData/combinedQuadMoon/SupplFig_QuadMoon_ModelTesting_012226';
...
for t = 1:numel(Tasks)
    ...
    %         taskName, nIterations, Param, combinedBasename));
    %     plot_MeanPredictedvsReportedPMbyParamwithMpERR(R.(taskName).all_testing_Tbl, Param, saveFilename, taskName, 'sd');
    % end
