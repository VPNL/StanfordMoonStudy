...
ResultsDir='/Users/kalanit/Projects/PerceptualMagnification/Paper/ExperimentalData/QuadExperiments/Results/Modeltesting_011326'
...
[meanErr,sdErr]=PM_Models_MSE(all_perceptual_testing_Tbl,perceptual_testing_png,figName);

Param='Real_Visual_Angle';
saveFilename=fullfile(ResultsDir,[perceptual_testing_Tblname '_by_VisualAngle.png'] );
plot_PredictedvsReportedPMbyParam(all_perceptual_testing_Tbl,Param,saveFilename,figName)
...
[meanErr,sdErr]=PM_Models_MSE(all_adjusted_testing_Tbl,adjusted_testing_png,figName);
...
plot_PredictedvsReportedPMbyParam(all_adjusted_testing_Tbl,Param,saveFilename,figName)
