...
[lme_Disparity_by_InverseDistance , lme_Disparity_by_Elevation, lme_Disparity_by_InverseDistanceNElevation,...
...
% now run only on stereoTypical
ii =find(modelTbl.NormedScore>stereoTypicalThreshold);
justStereoTypicalTable= modelTbl(ii,:);

[justStereoTypical_Disparity_by_InverseDistance , justStereoTypical_Disparity_by_Elevation, justStereoTypical_Disparity_by_InverseDistanceNElevation,...
    justStereoTypical_logPM_by_logInverseDistance, justStereoTypical_logPM_by_logElevation, justStereoTypical_logPM_by_logInverseDistanceNElevation] = ...
    Quad_Disparity_by_inverseDistanceElevation( ...
   justStereoTypicalTable, [tableName '_justStereoTypical'], transformResultsDir, saveLME, cmap, ...
    sortedIdx, transformId, 1, uniqueID, ...
    secondYAxisColor, colorConfig);



%% RS models for linear and log of inverse distance (1/D) and elevation (E)
