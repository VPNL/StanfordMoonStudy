% SMS_ExtendedFig1_MatchingbyStereoGroup082526
...
%% Run configuration
quadFile = fullfile(dataDir, 'StanfordQuad_merged_matching_0429_x7001.csv');
...
resultsDir = fullfile(expDir, 'Figures', 'ExtendedFig1', colorResultsFolder);
